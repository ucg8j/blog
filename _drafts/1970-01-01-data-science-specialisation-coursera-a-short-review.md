...
After using `R` for a couple of years, I decided it was time to learn in a more systematic way and hopefully take my skills to the next level. As thinking *'Coding, where the hell do I start?'* is not too distant a memory for me, I will keep the beginner in mind.
